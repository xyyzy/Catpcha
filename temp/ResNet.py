...
from keras.layers import Input, Add, Dense, Activation, ZeroPadding2D, BatchNormalization, Flatten, Conv2D, \
    AveragePooling2D, MaxPooling2D, GlobalMaxPooling2D, Dropout, Concatenate, Reshape
...
def convolutional_block(X, f, filters, stage, block, s=2):
    ...
    # SHORTCUT PATH
    X_shortcut = Conv2D(F3, kernel_size=(1, 1), strides=(s, s), padding='valid', name=conv_name_base + '1')(X_shortcut)
...
# %%
model.fit_generator(generator=data_gen, epochs=100)
